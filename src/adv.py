...
"North of you, the cave mount beckons", list_of_all_items[0:3] #This makes a new list from the first element.
),
...
while direction != "q":
    ...
    yes_no = input(f'Would you like to choose any of these items to keep{player.current_room.items} to pick up? Y or N').lower()
    if yes_no == "y":
        # player.grab_item
